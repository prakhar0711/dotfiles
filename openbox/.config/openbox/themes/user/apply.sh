...
apply_kitty() {
  # Kitty: Fonts
  kitty conf --load kitty.conf -o shell_always_use_gpu=false -o font="${terminal_font_name}" -o font_size="${terminal_font_size}"
  ...
  [colors.bright_background]
    black = "${background_bright}"
    red = "${color1_bright}"
    green = "${color2_bright}"
    yellow = "${color3_bright}"
    blue = "${color4_bright}"
    magenta = "${color5_bright}"
    cyan = "${color6_bright}"
    white = "${color7_bright}"
